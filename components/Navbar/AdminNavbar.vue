<template>
  <!-- Navbar -->
  <nav
    class="absolute top-0 left-0 z-10 flex items-center w-full p-4 bg-transparent md:flex-row md:bg-primary md:flex-nowrap md:justify-start"
  >
    <div
    ...
    >
      <!-- Brand -->
      <a
        class="hidden ml-4 text-sm font-semibold text-white uppercase lg:inline-block"
      ...
      >
        <div class="relative flex flex-wrap items-stretch w-full">
          ...
          <input
            type="text"
            placeholder="Search"
            class="relative w-full px-3 py-3 pl-10 mt-1 text-sm bg-white border-0 rounded shadow outline-none placeholder-blueGray-300 text-blueGray-600 focus:outline-none focus:ring"
          />
        </div>
      </form>
      <!-- User -->
