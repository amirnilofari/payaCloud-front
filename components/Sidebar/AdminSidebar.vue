      ...
      >
        ...
        >
          <div class="flex flex-wrap">
            <div class="w-6/12">
              <nuxt-link
                class="inline-block p-4 px-0 mr-0 text-sm font-bold text-left uppercase text-primary md:block md:pb-2 text-blueGray-600 whitespace-nowrap"
                to="/"
              >
                PAYACLOUD
              </nuxt-link>
